...
class ActivitySubChartPush {
  constructor({ pollMs = 1000, maxPoints = 0, dataType = 'Walking' } = {}) {
    ...
    this.dataType = dataType;   // 'Walking', 'LongestBout', 'Bouts', or 'Steps'
...
export const walkingChartPush = new ActivitySubChartPush({ 
  pollMs: 1000, 
  maxPoints: 10000, 
  dataType: 'Walking' 
});

export const stepsChartPush = new ActivitySubChartPush({ 
  pollMs: 1000, 
  maxPoints: 10000, 
  dataType: 'Steps' 
});

export const boutsChartPush = new ActivitySubChartPush({ 
  pollMs: 1000, 
  maxPoints: 10000, 
  dataType: 'Bouts' 
});
