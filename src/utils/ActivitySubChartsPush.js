...
class ActivitySubChartPush {
  constructor({ pollMs = 1000, maxPoints = 0, dataType = 'Walking' } = {}) {
...
export const walkingChartPush = new ActivitySubChartPush({ pollMs: 1000, maxPoints: 10000, dataType: 'Walking' });
export const stepsChartPush = new ActivitySubChartPush({ pollMs: 1000, maxPoints: 10000, dataType: 'Steps' });
export const boutsChartPush = new ActivitySubChartPush({ pollMs: 1000, maxPoints: 10000, dataType: 'Bouts' });
export const longestBoutChartPush = new ActivitySubChartPush({
  pollMs: 1000,
  maxPoints: 10000,
  dataType: 'LongestBout',
});
