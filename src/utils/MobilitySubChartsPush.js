...
export const stepTimeVariationChartPush = new MobilitySubChartsPush({
  pollMs: 1000,
  maxPoints: 10000,
  dataType: 'StepTimeVariation',
});
export const turnsChartPush = new MobilitySubChartsPush({ pollMs: 1000, maxPoints: 10000, dataType: 'Turns' });
export const symmetryProxyChartPush = new MobilitySubChartsPush({
  pollMs: 1000,
  maxPoints: 10000,
  dataType: 'SymmetryProxy',
});
export const cadenceChartPush = new MobilitySubChartsPush({ pollMs: 1000, maxPoints: 10000, dataType: 'Cadence' });
