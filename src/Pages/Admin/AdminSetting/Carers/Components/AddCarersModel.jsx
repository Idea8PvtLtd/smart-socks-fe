...
function AddCarersModel({ open, onClose, value, onChange, onSave }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <h3 className='from_head'>Add new nurse</h3>
      ...
      <div className='Alert'>
        {alertType === 'success' && (
          <AlertDemo
            type='success'
            title={content.CareSetting.successTitle}
            message={content.CareSetting.successAddMessage}
