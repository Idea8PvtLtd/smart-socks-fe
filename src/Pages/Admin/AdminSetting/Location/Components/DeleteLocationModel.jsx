...
function DeleteLocationModel({ open, onClose, onConfirm }) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content delete-modal" onClick={(e) => e.stopPropagation()}>
        <div className="delete-header">
          ...
          <h3 className="delete-title">Delete care location</h3>
        </div>
      ...
      <div className="Alert">
        {alertType === 'success' && (
          <AlertDemo
            type="success"
            title={content.LocationSetting.successDeleteTitle}
            message={content.LocationSetting.successDeleteMessage}
