...
import './AddNoteNotificationsModel.css';
const AddNoteNotificationsModel = ({ wearerId, onClose }) => {
    ...
    // Open/close modal based on wearerId
    useEffect(() => {
        if (wearerId) {
            setIsModalOpen(true);
            setActiveTab('view');
...
export default AddNoteNotificationsModel;