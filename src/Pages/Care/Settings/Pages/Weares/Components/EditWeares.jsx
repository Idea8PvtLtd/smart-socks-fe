...
function EditWeares({ open, onClose, value, onChange, onSave }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <h3 className='from_head'>update WEARERS details</h3>
      ...
      <div className='Alert'>
        {alertType === 'success' && (
          <AlertDemo
            ...
            message={content.Wearers.successEditMessage}
