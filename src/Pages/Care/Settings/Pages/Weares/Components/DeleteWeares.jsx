...
function DeleteWeares({ open, onClose, onConfirm }) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content delete-modal" onClick={(e) => e.stopPropagation()}>
        <div className="delete-header">
          ...
          <h3 className="delete-title">Delete Wearer</h3>
        </div>
        <p className="delete-text">
          Are you sure you want to delete this wearer? This action cannot be undone.
        </p>
      ...
      <div className="Alert">
        {alertType === 'success' && (
          <AlertDemo
            type="success"
            title={content.Wearers.successDeleteTitle}
            message={content.Wearers.successDeleteMessage}
